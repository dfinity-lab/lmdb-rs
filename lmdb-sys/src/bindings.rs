...
pub const MDB_VERSION_DATE: &'static [u8; 18usize] = b"December 19, 2015\0";
...
pub const MDB_PROBLEM: u64 = 18446744073709520837;
pub const MDB_LAST_ERRCODE: ::libc::c_int = -30779;
#[doc = " Unsigned type used for mapsize, entry counts and page/transaction IDs."]
#[doc = ""]
#[doc = "\tIt is normally size_t, hence the name. Defining MDB_VL32 makes it"]
#[doc = "\tuint64_t, but do not try this unless you know what you are doing."]
...
unsafe extern "C" {
    ...
    #[doc = "\t\tThis flag may be changed at any time using #mdb_env_set_flags()."]
    #[doc = "\t<li>#MDB_PREVSNAPSHOT"]
    #[doc = "\t\tOpen the environment with the previous snapshot rather than the latest"]
    #[doc = "\t\tone. This loses the latest transaction, but may help work around some"]
    #[doc = "\t\ttypes of corruption. If opened with write access, this must be the"]
    #[doc = "\t\tonly process using the environment. This flag is automatically reset"]
    #[doc = "\t\tafter a write transaction is successfully committed."]
    #[doc = " </ul>"]
...
unsafe extern "C" {
    ...
    #[doc = "\t<li>#MDB_NOSYNC"]
    #[doc = "\t\tDon't flush system buffers to disk when committing this transaction."]
    #[doc = "\t<li>#MDB_NOMETASYNC"]
    #[doc = "\t\tFlush system buffers but omit metadata flush when committing this transaction."]
    #[doc = " </ul>"]
...
unsafe extern "C" {
    ...
    #[doc = "\t\tor #mdb_size_t, and will be sorted as such."]
    #[doc = "\t\t(lmdb expects 32-bit int <= size_t <= 32/64-bit mdb_size_t.)"]
